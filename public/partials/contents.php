            ...
            <a href="/ads/<?php echo $ad->id; ?>">
                ...
                <div class="px-4 py-3 w-72">
                    ...
                    <div class="flex items-center">
                        ...
                        <del>
                            <p class="text-sm text-gray-600 cursor-auto ml-2"><?php echo $ad->status_name; ?> </p>
                        </del>
                        <div class="ml-auto">
                    ...
                    <p class="text-sm text-gray-600"><?php echo $ad->user; ?> (<?php echo $ad->gender; ?>) - <?php echo $ad->position; ?>, <?php echo $ad->phone; ?></p>
                </div>
            </a>
        </div>
