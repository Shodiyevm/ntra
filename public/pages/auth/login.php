                ...
                <form class="text-start" action="/login" method="post">
                    <div class="grid grid-cols-1">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="LoginPassword" type="password" class="form-input mt-3" placeholder="Password:" name="password">
                        </div>
                  ...
                  <a href="/signup" class="text-decoration-none">Don't have an account? Register</a>
                 </div>
                    </div>
                </form>
            </div>
