...
$redirectUrl = $necessaryUrl ? "/$necessaryUrl" : '/';
...
<div class="text-center">
    ...
    <a href="<?php echo $redirectUrl; ?>" class="mt-6 inline-block bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600">Go To The Previous Page</a>
</div>
</body>
</html>
