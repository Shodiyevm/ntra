                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            ...
                                            <input name="title" id="title" type="text" class="form-input ps-11" placeholder="Ads Title :" required value="<?= $ad->title ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            <i class="mdi mdi-arrow-expand-all absolute top-2 start-4 text-green-600"></i>
                                            <input name="address" id="address" type="text" class="form-input ps-11" placeholder="Manzil:"  value="<?= $ad->address ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-12">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            ...
                                            <textarea name="desc" id="desc" class="form-input ps-11" placeholder="E'lon bo'yicha ta'rif..." required>
                                                <?= $ad->description ?>
                                            </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:col-span-4 col-span-12 hidden">
                                        <div class="form-icon relative mt-2">
                                            <input name="user" value="<?= $user->id ?>" type="number" class="form-input ps-11">
                                        </div>
                                    </div>

                                    <div class="md:col-span-4 col-span-12 hidden">
                                        <div class="form-icon relative mt-2">
                                            <input name="status" value="<?= $status->id ?>" type="number" class="form-input ps-11">
                                        </div>
                                    </div>
