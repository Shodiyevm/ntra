                ...
                <div class="layout-specing">
                    ...
                    <div class="md:flex justify-between items-center">
                        ...
                        <ul class="tracking-[0.5px] inline-block sm:mt-0 mt-3">
                            <li class="inline-block"><a href="index.html" class="text-slate-600 dark:text-white hover:text-green-600"></a></li>
                            <li class="inline-block"><span class="mdi mdi-chevron-right text-slate-400"></span></li>
                        </ul>
                    </div>
